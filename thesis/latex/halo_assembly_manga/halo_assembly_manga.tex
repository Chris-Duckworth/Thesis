...
\label{ch:kin_mis}
\vspace{-5.25in}
\includegraphics[height=1.39in]{thesis/latex/kin_mis_files/kin_mis_chapter_heading_grey.pdf}
\vspace{3in}
...
In this chapter we explore these ideas with the following tests:
\begin{enumerate}
\item Cosmic web classification (\red{Section X})
\begin{itemize}
...
\end{itemize}
\item Stellar to halo mass ratio  (\red{Section Y})
\begin{itemize}
...
\end{itemize}
\item HOD modelling (\red{Section Z})
\begin{itemize}
...
\section{Data}
In this chapter, we base our analysis on 4633 unique galaxy observations corresponding to the 6th MaNGA product launch (MPL). This reflects the completion of the survey as of mid-2018 (data released publicly December 2018). \red{Here, we describe the additional data used and our sample selection.}
...
\begin{figure}
	\includegraphics[width=\linewidth]{thesis/latex/halo_assembly_manga/sample_consistency.pdf}
...
\red{This section needs putting into my own words. This was written by K. Kraljic.}
...
\begin{figure}
	\includegraphics[width=\linewidth]{thesis/latex/halo_assembly_manga/PA_ALL_CW.pdf}
...
\begin{figure}
	\includegraphics[width=\linewidth]{thesis/latex/halo_assembly_manga/PA_ET_CW.pdf}
...
\begin{figure}
	\includegraphics[width=\linewidth]{thesis/latex/halo_assembly_manga/stel_halo_ratio_bin0_10_20_30_90.pdf}
